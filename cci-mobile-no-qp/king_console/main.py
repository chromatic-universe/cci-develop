...
def local_mac_addr() :
        ...
        '''
        try :
            return base64.b64encode( proc.check_output( ['cat' ,  '/sys/class/net/eth0/address'] ).strip().lower() )
        except :
            pass
...
class kingconsoleApp( App ) :
            ...
            try :
                   ...
                   if platform == 'android' :
                        ...
                        try :
                            ...
                            if out :
                                pos = out.decode().find( '<ip_info>' )
                                if pos :
                                    out = out[:pos]
                                out , out2 = out.decode().split( ':' )
        ...
        def on_stop( self ) :
            ...
            #stop threads
            for moniker,atom in self._thrd.thrds.items() :
                atom['stop_alert'].set()
                if atom['instance'] :
                    atom['instance'].join()
                ...
                while not self.dbq.empty() :
                    ...
                    try :
                        ...
                        try :
                            ...
                            self._logger.error( '..in db function call...' + str( e ) )
                    finally :
                        db.db_lk.release()
        ...
        def _check_connectivity( self ) :
                    ...
                    if platform == 'android':
                        try:
                            ...
                            self._logger.error( 'check connectivity failed....' +  str( e ) )
                            return False
                    else :
